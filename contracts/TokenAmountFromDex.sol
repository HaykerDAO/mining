...
contract TokenAmountFromDex is Ownable {
    ...
    DexPairLike public haiHkrPairContract = DexPairLike(0x208B5ADd7918db2E36811436CEe87deEF1dA73C2); // dogeswap pair
    ...
    function getTokenAmount(address _token, uint256 hkrAmount) external view returns (uint256){ 
        ...
        (uint112 haiReserve, uint112 hkrReserve, uint32 blockTimestampLast) = haiHkrPairContract.getReserves();
        if(hkrReserve > 0){
